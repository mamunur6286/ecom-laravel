                    ...
                    @foreach($messages as $message)
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-6">
                                        <a class="btn btn-sm btn-info" href="{{ route('user-messages.edit',$message->id) }}"><i class="fa fa-arrow-up"></i></a>
                                    </div>
                                    <div class="col-md-6">
                                        <form id="from1" action="{{ route('user-messages.destroy',$message->id) }}" method="post">
                                            {{ csrf_field() }}

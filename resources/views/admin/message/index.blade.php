                    ...
                    @foreach($messages as $message)
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-6">
                                        <a class="btn btn-sm btn-info" href="{{ route('user-contact.edit',$message->id) }}"><i class="fa fa-arrow-up"></i></a>
                                    </div>
                                    <div class="col-md-6">
                                        <form id="from1" action="{{ route('user-contact.destroy',$message->id) }}" method="post">
                                            {{ csrf_field() }}
